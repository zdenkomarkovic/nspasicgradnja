      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {services.map((service) => (
            <div
              key={service.title}
              className="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm hover:shadow-lg hover:border-[#f97316]/20 transition-all duration-300 group flex flex-col"
            >
              ...
              <div className="mt-auto">
                <Link
                  href={service.href}
                  className="inline-flex items-center gap-2 text-[#f97316] font-semibold text-sm hover:gap-3 transition-all duration-200 border border-[#f97316]/30 hover:border-[#f97316] rounded-lg px-4 py-2.5 hover:bg-[#f97316]/5"
                >
                  Saznaj više
