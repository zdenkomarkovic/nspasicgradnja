...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          {/* Left: text */}
          <div>
            <h1 className="text-2xl sm:text-5xl font-bold text-white leading-tight mb-3 sm:mb-6">
